...
const Version = "1.9.24" // Current provider version
...
var _ provider.ProviderWithActions = (*fivetranProvider)(nil)

func (p *fivetranProvider) Actions(ctx context.Context) []func() action.Action {
	return []func() action.Action{
		actions.ConnectionSchemaReload,
	}
}
...
func (p *fivetranProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		resources.ConnectionSchemasConfig,
		resources.ConnectionSchemaTablesConfig,
		resources.ConnectionTableColumnsConfig,
	}
}
