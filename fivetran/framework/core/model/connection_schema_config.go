...
type ConnectionSchemaResourceModel struct {
...
func (d *ConnectionSchemaResourceModel) IsValid() bool {
...
func (d *ConnectionSchemaResourceModel) getValidationLevels() (bool, bool) {
...
func (d *ConnectionSchemaResourceModel) ValidateSchemaElements(response connections.ConnectionSchemaDetailsResponse, client fivetran.Client, ctx context.Context) (error, bool) {
	validateTables, validateColumns := d.getValidationLevels()
	if validateTables {
		return d.GetSchemaConfig().ValidateSchemas(
			d.ConnectionId.ValueString(),
...
func (d *ConnectionSchemaResourceModel) IsRawSchemaDefined() bool {
	return !d.SchemasRaw.IsUnknown() && !d.SchemasRaw.IsNull() && len(d.SchemasRaw.ValueString()) > 0
}

func (d *ConnectionSchemaResourceModel) IsLegacySchemaDefined() bool {
	return !d.Schema.IsUnknown() && !d.Schema.IsNull() && len(d.Schema.Elements()) > 0
}

func (d *ConnectionSchemaResourceModel) IsMappedSchemaDefined() bool {
	return !d.Schemas.IsUnknown() && !d.Schemas.IsNull() && len(d.Schemas.Elements()) > 0
}

func (d *ConnectionSchemaResourceModel) ReadFromResponse(response connections.ConnectionSchemaDetailsResponse, diag *diag.Diagnostics) {
...
func (d *ConnectionSchemaResourceModel) getNullSchema() basetypes.SetValue {
...
func (d *ConnectionSchemaResourceModel) getNullSchemas() basetypes.MapValue {
...
func (d *ConnectionSchemaResourceModel) GetSchemaConfig() configSchema.SchemaConfig {
...
func (d *ConnectionSchemaResourceModel) getSchemasRawValue(schemas []interface{}) string {
	result := mapRawSchemas(schemas)
	resultRawString, _ := json.Marshal(result)
	return string(resultRawString)
}

func (d *ConnectionSchemaResourceModel) getSchemasMap(schemas []interface{}) basetypes.MapValue {
	columnsAttrTypes := map[string]attr.Type{
		"enabled":        types.BoolType,
		"hashed":         types.BoolType,
		"is_primary_key": types.BoolType,
...
func (d *ConnectionSchemaResourceModel) tryGetLocalSchema(mappedSchemas map[string]interface{}, schema string) map[string]interface{} {
	if v, ok := mappedSchemas[schema]; ok {
		return v.(map[string]interface{})
	}
	return map[string]interface{}{}
}
func (d *ConnectionSchemaResourceModel) tryGetLocalTable(mappedSchema map[string]interface{}, table string) map[string]interface{} {
...
func (d *ConnectionSchemaResourceModel) tryGetLocalColumn(mappedTable map[string]interface{}, column string) map[string]interface{} {
...
func (d *ConnectionSchemaResourceModel) getLegacySchemaItems(schemas []interface{}) basetypes.SetValue {
...
func (d *ConnectionSchemaResourceModel) getLegacySchemas() []interface{} {
	schemas := []interface{}{}
...
func (d *ConnectionSchemaResourceModel) getSchemasRaw() []interface{} {
	schemas := []interface{}{}
...
func (d *ConnectionSchemaResourceModel) getSchemas() []interface{} {
	schemas := []interface{}{}
...
func (d *ConnectionSchemaResourceModel) mapLocalSchemas() map[string]interface{} {
