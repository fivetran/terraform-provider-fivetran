...
func GetDatasourceConnectionConfigSchemaAttributes() map[string]datasourceSchema.Attribute {
...
func GetResourceConnectionConfigSchemaAttributes() map[string]resourceSchema.Attribute {
...
func GetResourceConnectionConfigSchemaBlocks() map[string]resourceSchema.Block {
