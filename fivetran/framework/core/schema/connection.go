...
func ConnectionResourceBlocks(ctx context.Context) map[string]resourceSchema.Block {
	return map[string]resourceSchema.Block{
		...
		"config": resourceSchema.SingleNestedBlock{
			Attributes: GetResourceConnectionConfigSchemaAttributes(),
			Blocks:     GetResourceConnectionConfigSchemaBlocks(),
		},
...
func ConnectionDatasourceBlocks() map[string]datasourceSchema.Block {
	return map[string]datasourceSchema.Block{
		...
		"config": datasourceSchema.SingleNestedBlock{
			Attributes: GetDatasourceConnectionConfigSchemaAttributes(),
		},
