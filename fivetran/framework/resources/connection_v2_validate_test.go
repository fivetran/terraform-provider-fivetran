...
func connectionV2ValidateConfigRequestWithDynamic(t *testing.T, service types.String, configValue, authValue types.Dynamic) resource.ValidateConfigRequest {
	...
	data := model.ConnectionV2ResourceModel{
		...
		ConnectCardConfig:        types.ObjectNull(model.ConnectionV2ConnectCardConfigAttrTypes()),
		DestinationSchemaNames:   types.StringNull(),
		DestinationConfiguration: types.ObjectNull(model.ConnectionV2DestinationConfigurationAttrTypes()),
