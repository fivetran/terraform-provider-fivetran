...
func TestDataSourceConnectorConfigMappingMock(t *testing.T) {
	...
	step1 := resource.TestStep{
		...
		Check: resource.ComposeAggregateTestCheckFunc(
			...
			//  after OAS update we will re-validate this field resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.oauth_token", "******"),
			//  after OAS update we will re-validate this field resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.oauth_token_secret", "******"),
			...
			resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.account_key", "******"),
			resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.passphrase", "******"),
			...
			resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.uri", "uri"),
			resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.auth", "auth"),
			resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.data_access_method", "data_access_method"),
			resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.is_ftps", "false"),

			resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.is_private_key_encrypted", "false"),
			...
			resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.replica_id", "999999"),
			...
			//  after OAS update we will re-validate this field  resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.api_type", "api_type"),
			...
			/// after OAS update we will re-validate this field resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.network_code", "network_code"),
			...
			/// after OAS update we will re-validate this field resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.test_table_name", "test_table_name"),
			...
			/// after OAS update we will re-validate this field resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.unique_id", "unique_id"),
			...
			// after OAS update we will re-validate this field resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.report_suites.0", "report_suite"),
			// after OAS update we will re-validate this field resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.elements.0", "element"),
			// after OAS update we will re-validate this field resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.organization", "organization"),
			...
			resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.api_keys.0", "api_key"),
			...
			resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.primary_keys.0", "primary_key"),
			...
			resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.is_single_table_mode", "false"),
			...
			resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.csv_definition", "csv_definition"),
			resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.export_storage_type", "export_storage_type"),
			...
			// after OAS update we will re-validate this field resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.environment", "environment"),
