...
func TestDataSourceConnectorConfigMappingMock(t *testing.T) {
	...
	step1 := resource.TestStep{
		...
		Check: resource.ComposeAggregateTestCheckFunc(
			...
			//nested field resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.oauth_token", "******"),
			//nested field resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.oauth_token_secret", "******"),
			...
			// doesnt exist in open api sepc resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.daily_api_call_limit", "0"),
			...
			// doesnt exist in open api spec resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.api_type", "api_type"),
			...
			// there is no servers of type string in Open api spec resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.servers", "servers"),
			...
			// doesnt exist in open api spec resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.test_table_name", "test_table_name"),
			...
			// doesnt exist in open api specresource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.unique_id", "unique_id"),
			...
			// doesnt exist in open api spec resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.organization", "organization"),
			...
			// nested field will be covered resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.report_suites.0", "report_suite"),
			// nested field will be covered resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.elements.0", "element"),
			// nested field will be covered resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.metrics.0", "metric"),
			...
			// no fields string in open api schemaresource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.fields.0", "field"),
			...
			// doesnt exist in open api resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.environment", "environment"),
			...
			// nested field not covered currently resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.custom_tables.0.breakdowns.0", "breakdown"),
			// nested field not covered currently resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.custom_tables.0.action_breakdowns.0", "action_breakdown"),
