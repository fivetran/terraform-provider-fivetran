...
func TestDataSourceConnectorConfigMappingMock(t *testing.T) {
	...
	step1 := resource.TestStep{
		...
		Check: resource.ComposeAggregateTestCheckFunc(
			...
			// Dont know yet what is the issue resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.oauth_token", "******"),
			// Dont know yet what is the issue resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.oauth_token_secret", "******"),
			...
			// will be fixed resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.daily_api_call_limit", "0"),
			...
			// will be fixed resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.api_type", "api_type"),
			...
			// will be fixed resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.servers", "servers"),
			...
			// will be fixed resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.network_code", "network_code"),
			...
			// will be fixed resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.test_table_name", "test_table_name"),
			...
			// will be fixed resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.unique_id", "unique_id"),
			...
			// will be fixed resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.organization", "organization"),
			...
			// will be fixed resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.report_suites.0", "report_suite"),
			// will be fixed resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.elements.0", "element"),
			...
			// will be fixed resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.is_single_table_mode", "true"),
			...
			// will be fixed resource.TestCheckResourceAttr("data.fivetran_connector.test_connector", "config.0.environment", "environment"),
