...
func TestDataSourceWebhooksMappingMock(t *testing.T) {
	step1 := resource.TestStep{
		...
		Check: resource.ComposeAggregateTestCheckFunc(
			...
			resource.TestCheckResourceAttr("data.fivetran_webhooks.test_webhooks", "webhooks.1.events.0", "sync_end"),
			resource.TestCheckResourceAttr("data.fivetran_webhooks.test_webhooks", "webhooks.1.events.1", "sync_start"),
