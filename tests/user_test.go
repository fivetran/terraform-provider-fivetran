...
func TestFivetranUser_basic(t *testing.T) {
		...
		Steps: []resource.TestStep{
		  ...
		  `,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("fivetran_user.userjohn", "email", "john.black@testmail.com"),
					resource.TestCheckResourceAttr("fivetran_user.userjohn", "family_name", "Black"),
		  ...
		  `,
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("fivetran_user.userjohn", "email", "john.black@testmail.com"),
					resource.TestCheckResourceAttr("fivetran_user.userjohn", "family_name", "White"),
