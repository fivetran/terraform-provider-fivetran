...
## [Unreleased](https://github.com/fivetran/terraform-provider-fivetran/compare/v1.3.3...HEAD)


## [1.3.3](https://github.com/fivetran/terraform-provider-fivetran/compare/v1.3.2...v1.3.3)

## Updated
- Update documents regarding `schema_change_handling` not being required
